...
class MailgunSender
{
    ...
    {
        return $_SERVER['TINY_MAILGUN_API_KEY'] ?? '';
    }
    ...
    public function sendTextEmail(
        ...
        $from_email = $from_email ?? $_SERVER['TINY_MAILGUN_FROM_ADDRESS'];
        $from_name = $from_name ?? $_SERVER['TINY_MAILGUN_FROM_NAME'];
        $domain = $domain ?? $_SERVER['TINY_MAILGUN_DOMAIN'];
